...
const UserDelete = ({
  ...
  const getFriendlyErrorMessage = (err) => {
    ...
    if (
      ...
      errMsg.includes("courses") ||
      errMsg.includes("attempts") ||
      errMsg.includes("answers")
    ) {
      return "Pengguna tidak dapat dihapus karena sudah memiliki keterkaitan data (seperti mengampu kelas, mengikuti ujian, atau riwayat pengerjaan).";
    }
    return errMsg || "Gagal menghapus pengguna. Silakan coba lagi.";
  };
    ...
    <div className="flex flex-col">
      ...
      <div className="p-8 pb-4 flex flex-col">
        ...
        <p className="text-[#475467] leading-relaxed">
          ...
          <span className="text-[#344054]">{user?.name}</span>?
        </p>
      </div>
